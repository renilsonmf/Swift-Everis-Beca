...
//  enggplant-alura
//
//  Created by Renilson Moreira Ferreira on 11/03/21.
...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, AdicionaItensDelegate {
    ...
    // A ! Informa que a variavl tera um valor
    @IBOutlet weak var nomeTextField: UITextField?
    @IBOutlet weak var felicidadeTextField: UITextField?
    
    // MARK: - View life cycle = Depois que a view é carregada
    // Criacao de botao manualmente
    ...
    // Esse campo checa o campo que o usuario cliclou marcando com um visto azul 
